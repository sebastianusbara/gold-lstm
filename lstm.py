...
model = Sequential()
# LSTM 1st Layer
model.add(LSTM(units=NEURON_UNITS, return_sequences=True, input_shape=(1, lookback)))

# LSTM 2nd Layer
model.add(LSTM(units=NEURON_UNITS, return_sequences=False))
...
# for 20 years
yticksvalue = np.arange(15000000, 34000000, 3000000)
ytickslabel = [
    "15,000,000", "18,000,000", "21,000,000",
    "24,000,000", "27,000,000", "30,000,000", "33,000,000"
]
