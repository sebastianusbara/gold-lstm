...
MSE_scaled = score[1]
MSE = np.sqrt(sc.inverse_transform([MSE_scaled]))

print('Predictions and Actual Gold Prices - LSTM (1 Year / 360 Days):')
print('MSE Scaled ' + str(score[1]))
...
plt.title('Predictions and Actual Gold Prices - LSTM (1 Year / 360 Days)', family='Arial', fontsize=12)
