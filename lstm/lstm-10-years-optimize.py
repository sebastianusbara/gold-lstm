...
dataset_train = pd.read_csv("data/train-3600.csv", index_col=0, delimiter=",", decimal=".")
...
print('Predictions and Actual Gold Prices - LSTM (10 Year / 3600 Days) with Grid Search:')
...
yticksvalue = np.arange(4000000, 28000000, 4000000)
ytickslabel = [4, 8, 12, 16, 20, 24]
plt.yticks(yticksvalue, ytickslabel)
plt.legend(shadow=True)
plt.title(
    'Predictions and Actual Gold Prices - LSTM (10 Years / 3600 Days) with ADAM Optimizer',
