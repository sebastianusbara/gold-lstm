...
dataset_train = pd.read_csv("data/train-90.csv", index_col=0, delimiter=",", decimal=".")
...
print('Predictions and Actual Gold Prices - LSTM (3 Months / 90 Days) with Grid Search:')
...
yticksvalue = np.arange(20000000, 22000000, 200000)
ytickslabel = [20, 20.2, 20.4, 20.6, 20.8, 21, 21.2, 21.4, 21.6, 21.8]
plt.yticks(yticksvalue, ytickslabel)
plt.legend(shadow=True)
plt.title('Predictions and Actual Gold Prices - LSTM (3 Months / 90 Days) with ADAM Optimizer', family='Arial', fontsize=12)
