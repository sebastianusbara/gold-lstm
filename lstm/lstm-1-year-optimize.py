...
dataset_train = pd.read_csv("data/train-360.csv", index_col=0, delimiter=",", decimal=".")
...
print('Predictions and Actual Gold Prices - LSTM (1 Year / 360 Days) with Grid Search:')
...
yticksvalue = np.arange(17000000, 23400000, 800000)
ytickslabel = [17, 17.8, 18.6, 19.4, 20.2, 21, 21.8, 22.6]
plt.yticks(yticksvalue, ytickslabel)
plt.legend(shadow=True)
plt.title(
    'Predictions and Actual Gold Prices - LSTM (1 Year / 360 Days) with ADAM Optimizer',
