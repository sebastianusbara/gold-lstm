...
print('Predictions and Actual Gold Prices - LSTM (5 Year / 1800 Days) with Grid Search:')
...
plt.title(
    'Predictions and Actual Gold Prices - LSTM (5 Year / 1800 Days) with ADAM Optimizer',
