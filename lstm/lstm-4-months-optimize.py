...
dataset_train = pd.read_csv("data/train-120.csv", index_col=0, delimiter=",", decimal=".")
...
print('Predictions and Actual Gold Prices - LSTM (4 Months / 120 Days) with Grid Search:')
...
yticksvalue = np.arange(19400000, 22400000, 400000)
ytickslabel = [19.4, 19.8, 20.2, 20.6, 21, 21.4, 21.8, 22.4]
plt.yticks(yticksvalue, ytickslabel)
plt.legend(shadow=True)
plt.title('Predictions and Actual Gold Prices - LSTM (4 Months / 120 Days) with ADAM Optimizer', family='Arial', fontsize=12)
