...
print('Predictions and Actual Gold Prices - LSTM (4 Months / 120 Days):')
...
plt.title('Predictions and Actual Gold Prices - LSTM (4 Months / 120 Days)', family='Arial', fontsize=12)
