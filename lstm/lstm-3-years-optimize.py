...
dataset_train = pd.read_csv("data/train-1080.csv", index_col=0, delimiter=",", decimal=".")
...
print('Predictions and Actual Gold Prices - LSTM (3 Year / 1080 Days) with Grid Search:')
...
yticksvalue = np.arange(15000000, 23000000, 1000000)
ytickslabel = [15, 16, 17, 18, 19, 20, 21, 22]
plt.yticks(yticksvalue, ytickslabel)
plt.legend(shadow=True)
plt.title(
    'Predictions and Actual Gold Prices - LSTM (3 Year / 1080 Days) with ADAM Optimizer',
