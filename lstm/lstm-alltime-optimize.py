...
model.add(LSTM(units=NEURON_UNIT, return_sequences=True, input_shape=(
...
print('Predictions and Actual Gold Prices - LSTM (19 Years / Alltime) with Grid Search:')
...
title = 'Predictions and Actual Gold Prices - LSTM (All Time / 19 Years) '
sub_title = '/ Hyperparameter Tuning with Grid Search'

plt.yticks(yticksvalue, ytickslabel)
plt.legend(shadow=True)
plt.title(title + sub_title, family='Arial', fontsize=12)
