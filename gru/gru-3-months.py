...
print('Predictions and Actual Gold Prices - GRU (3 Months / 90 Days):')
...
plt.title('Predictions and Actual Gold Prices - GRU (3 Months / 90 Days)', family='Arial', fontsize=12)
