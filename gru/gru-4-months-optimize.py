...
print('Predictions and Actual Gold Prices - GRU (4 Months / 120 Days) with Grid Search:')
...
plt.title('Predictions and Actual Gold Prices - GRU (4 Months / 120 Days) with ADAM Optimizer', family='Arial', fontsize=12)
