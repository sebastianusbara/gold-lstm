...
print('Predictions and Actual Gold Prices - GRU (10 Years / 3600 Days) with Grid Search:')
...
plt.title(
    'Predictions and Actual Gold Prices - GRU (10 Years / 3600 Days) with Grid Search',
