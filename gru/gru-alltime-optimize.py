...
model.add(GRU(units=128, return_sequences=True, input_shape=(
...
print('Predictions and Actual Gold Prices - GRU (All Time / 19 Years) with Grid Search:')
...
plt.title('Predictions and Actual Gold Prices - GRU (All Time / 19 Years) with Grid Search', family='Arial',
          fontsize=12)
