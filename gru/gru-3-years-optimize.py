...
print('Predictions and Actual Gold Prices - GRU (3 Years / 1080 Days) with Grid Search:')
...
plt.title(
    'Predictions and Actual Gold Prices - GRU (3 Year / 1080 Days) with ADAM Optimizer',
