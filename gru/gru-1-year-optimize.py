...
print('Predictions and Actual Gold Prices - GRU (1 Years / 360 Days) with Grid Search:')
...
plt.title(
    'Predictions and Actual Gold Prices - GRU (1 Year / 360 Days) with ADAM Optimizer',
