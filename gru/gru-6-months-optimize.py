...
print('Predictions and Actual Gold Prices - GRU (6 Months / 180 Days) with Grid Search:')
...
plt.title(
    'Predictions and Actual Gold Prices - GRU (6 Months / 180 Days) with ADAM Optimizer',
