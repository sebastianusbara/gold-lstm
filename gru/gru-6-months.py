...
print('Predictions and Actual Gold Prices - GRU (6 Months / 180 Days):')
...
plt.title('Predictions and Actual Gold Prices - GRU (6 Months / 180 Days)', family='Arial', fontsize=12)
