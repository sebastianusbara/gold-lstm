...
print('Predictions and Actual Gold Prices - GRU (All Time / 19 Years):')
...
plt.title('Predictions and Actual Gold Prices - GRU (All Time / 19 Years)', family='Arial', fontsize=12)
