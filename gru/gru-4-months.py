...
print('Predictions and Actual Gold Prices - GRU (4 Months / 120 Days):')
...
plt.title('Predictions and Actual Gold Prices - GRU (4 Months / 120 Days)', family='Arial', fontsize=12)
