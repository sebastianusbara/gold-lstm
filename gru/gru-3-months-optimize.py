...
model.add(GRU(units=NEURON_UNIT, return_sequences=True, input_shape=(
...
print('Predictions and Actual Gold Prices - GRU (3 Months / 90 Days) with Grid Search:')
...
plt.title('Predictions and Actual Gold Prices - GRU (3 Months / 90 Days) with ADAM Optimizer', family='Arial', fontsize=12)
